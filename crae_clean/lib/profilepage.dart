 ...
 Widget build(BuildContext context) {
   ...
   double h = MediaQuery.of(context).size.height;
    return Scaffold(
      ...
      appBar: 
      AppBar(title: Text("โปรไฟล์ของคุณ",style: TextStyle(fontSize: 20 ),),),
      body:Column(
        children: [
          //SizedBox(height: 30,),
          Container(
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
              Text("ชื่อ-นามสกุล ของคุณ",style: TextStyle(fontSize: 18,color: Colors.black),),
              Container(
              ...
              SizedBox(height: 10,),
              Text("เปลี่ยนรหัสผ่าน",style: TextStyle(fontSize: 20,color: Colors.black),),
              Container(
                decoration: BoxDecoration(
                  color: Colors.white,
                  borderRadius: BorderRadius.circular(10),
          ...
          Container(
            ...
            child:ElevatedButton(child: Text("บันทึก",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold,color: Colors.white)),onPressed: (){
